...
const socialLinks = [
  { name: "Twitter", href: "https://twitter.com/payflo_dev", icon: "twitter" },
  { name: "LinkedIn", href: "https://linkedin.com/company/payflo-dev", icon: "linkedin" },
  { name: "GitHub", href: "https://github.com/payflo-dev", icon: "github" },
];

export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-gray-900 pt-16 pb-8 text-white">
      ...
      <div className="absolute top-0 right-0 left-0 h-1 animate-gradient-x bg-[length:200%_auto] bg-gradient-to-r from-payflo-purple via-payflo-blue to-payflo-purple"></div>
      ...
      <div className="container-custom relative">
        <div className="grid grid-cols-1 gap-8 border-gray-800 border-b pb-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            <h3 className="mb-4 font-semibold text-lg text-white/90 transition-colors duration-300 hover:text-white">
              Company
            </h3>
